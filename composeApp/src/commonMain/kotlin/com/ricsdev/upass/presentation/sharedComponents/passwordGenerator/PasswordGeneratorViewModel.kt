package com.ricsdev.upass.presentation.sharedComponents.passwordGenerator

import androidx.lifecycle.ViewModel
import com.ricsdev.upass.domain.model.Password
        ...
        if (state.isPassphrase) {
            ...
            updatePasswordState {
                copy(
                    ...
                    history = (history + password.toString()).takeLast(10)
                )
            }
        }
    }
